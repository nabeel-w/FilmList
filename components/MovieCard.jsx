  ...
  return (
    <Link href={link}>
      <div className={disable?"max-w-sm rounded overflow-hidden shadow-lg opacity-50":"max-w-sm rounded overflow-hidden shadow-lg"} >
        ...
        <div class="flex items-center mt-2.5 mb-5 ms-6">
          {stars.map(star=>{
            ...
            {isList&&<button className={isDisable?"green_btn ms-3 me-2":"black_btn ms-3 me-2"} onClick={!isDisable&&handleComplete}><CheckCircleOutlineIcon /></button>}
        </div>
